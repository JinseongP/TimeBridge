...
def build_dataloader_train_cond(config, args=None):
    batch_size = config['dataloader']['sample_size']
    jud = config['dataloader']['shuffle']
    config['dataloader']['train_dataset']['params']['output_dir'] = args.save_dir
    if args.mode == 'infill':
        config['dataloader']['train_dataset']['params']['missing_ratio'] = args.missing_ratio
    elif args.mode == 'predict':
        config['dataloader']['train_dataset']['params']['predict_length'] = args.pred_len
    dataset = instantiate_from_config(config['dataloader']['train_dataset'])
