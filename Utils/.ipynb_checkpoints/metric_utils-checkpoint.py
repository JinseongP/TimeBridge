...
def visualization(ori_data, generated_data, analysis, data, save_dir, compare=3000):
  ...
  """
    ...
    if analysis == 'pca':
        ...
        plt.scatter(pca_results[:, 0], pca_results[:, 1],
                    s=3, c=colors[:anal_sample_no], alpha=0.2, label="Original")
        plt.scatter(pca_hat_results[:, 0], pca_hat_results[:, 1],
                    s=3, c=colors[anal_sample_no:], alpha=0.2, label="Synthetic")
        ...
        # plt.ylabel('y_pca')
        f.tight_layout()
        plt.savefig(f'{save_dir}/{data}_{analysis}.png',  bbox_inches='tight')
        plt.savefig(f'{save_dir}/{data}_{analysis}.pdf',  bbox_inches='tight')
        plt.show()
